function [inner_gamma_varied,outer_gamma_varied, inner_rho_varied, outer_rho_varied]...
    =generateCEOPlots(mu,fixed_rho_12,fixed_rho_23,fixed_gammas)
...
for i=1:length(gammas)
    ...
    [inner_bound_array(i),outer_bound_array(i),inner_optimizers, ...
        ...
        [0, gammas(i),0], rhos, 1,0,initial_w, []);
